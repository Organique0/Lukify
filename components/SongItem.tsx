...
const SongItem: React.FC<SongItemProps> = ({ song, onClick }) => {
    ...
    return (
        <div key={song.id} onClick={() => onClick(song.id)} className="relative group flex flex-col items-center justify-center rounded-md overflow-hidden gap-x-4 bg-neutral-400/5 cursor-pointer hover:bg-neutral-400/10 transition p-3">
